...
public static class NetworkUtils
{
    ...
    /// </summary>
    /// <returns></returns>
    public static async Task<(bool result, IPAddress? mcastIfaceAddr)> TryGetBestLocalIFAddrAsync(string dnsIpAddr = "8.8.8.8")
    {
        IPAddress? addr = null;
        bool success = false;
        ...
        try
        {
            ...
            await socket.ConnectAsync(dnsIpAddr, 65530);
